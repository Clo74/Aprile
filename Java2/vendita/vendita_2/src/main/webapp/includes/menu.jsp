        ...
        <ul class="pure-menu-list">
            ...
            <li class="pure-menu-item pure-menu-has-children pure-menu-allow-hover">
                ...
                <ul class="pure-menu-children">
                    <li class="pure-menu-item"><a href="${pageContext.request.contextPath}/AnagNegozio.jsp" class="pure-menu-link">Tags</a></li>
            ...
            <li class="pure-menu-item pure-menu-has-children pure-menu-allow-hover">
                ...
                <ul class="pure-menu-children">
                    <li class="pure-menu-item"><a href="#" class="pure-menu-link">Corsi frequentati</a></li>
